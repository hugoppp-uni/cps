...
public class ParkingGuidanceSystem 
{
    ...
    private Func<StreetEdge, double> _congestionEdgeWeights = edge => edge.CurrentCoverDuration(); // todo this doesnt work for some reason
        ...
        bool logging)
    {
        ...
        _searchEdgeWeights = _speedLimitEdgeWeights;
    }
